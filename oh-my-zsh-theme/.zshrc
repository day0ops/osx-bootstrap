...
export GLOO_EDGE_GRAPHQL_LICENSE_KEY=%%GLOO_EDGE_GRAPHQL_LICENSE_KEY%%

# Gloo Platform
export GLOO_PLATFORM_GLOO_MESH_LICENSE_KEY=%%GLOO_PLATFORM_GLOO_MESH_LICENSE_KEY%%
export GLOO_PLATFORM_GLOO_GATEWAY_LICENSE_KEY=%%GLOO_PLATFORM_GLOO_GATEWAY_LICENSE_KEY%%
export GLOO_PLATFORM_GLOO_NETWORK_LICENSE_KEY=%%GLOO_PLATFORM_GLOO_NETWORK_LICENSE_KEY%%
export GLOO_PLATFORM_GLOO_CORE_LICENSE_KEY=%%GLOO_PLATFORM_GLOO_CORE_LICENSE_KEY%%

# Licenses for Gloo Platform Development
export GLOO_GATEWAY_LICENSE_KEY=%%GLOO_GATEWAY_LICENSE_KEY%%
export GLOO_MESH_LICENSE_KEY=%%GLOO_MESH_LICENSE_KEY%%
export GLOO_NETWORK_LICENSE_KEY=%%GLOO_NETWORK_LICENSE_KEY%%
export GLOO_CORE_LICENSE_KEY=%%GLOO_CORE_LICENSE_KEY%%
